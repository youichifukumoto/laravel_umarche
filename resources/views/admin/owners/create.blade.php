            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="container px-5 mx-auto">
                        ...
                        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">メーカー登録</h1>
                        ...
                        <div class="-m-2">
                            <div class="p-2 w-2/3 mx-auto">
                                <div class="relative">
                                    ...
                                    <input type="text" id="name" name="name" repuired class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                            </div>
                            <div class="p-2 w-2/3 mx-auto">
                                <div class="relative">
                            ...
                            <div class="p-2 w-full flex justify-around mt-4">
                                ...
                                <button class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-700 rounded text-lg">登録</button>
                            </div>
                        </div>
                    </div>
                    </section>
