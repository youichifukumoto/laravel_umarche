                    ...
                    <form method="POST" action="{{ route('owner.images.update', ['image'=>$image->id]) }}">
                          ...
                          <div class="-m-2">
                                <div class="p-2 w-2/3 mx-auto">
                                    <div class="relative">
                                        <label for="titlw" class="leading-7 text-sm text-gray-600" >タイトル</label>
                                ...
                                <div class="p-2 w-full flex justify-around mt-4">
                                    <button  type="button" onclick="location.href='{{ route('owner.images.index') }}'" class="text-white bg-gray-400 border-0 py-2 px-8 focus:outline-none hover:bg-gray-300 rounded text-lg">戻る</button>
