                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <section class="text-gray-600 body-font relative">
                       <div class="container px-5 mx-auto">
                            ...
                            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">顧客登録</h1>
                            ...
                            <div class="-m-2">
                                ...
                                <div class="p-2 w-2/3 mx-auto">
                                    <div class="relative">
                                        ...
                                        <div class="flex">
                                            <input type="text" id="betting_rate" name="betting_rate" value="{{ old('betting_rate')}}" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                            <span class="flex items-center ml-1">％</span>
                                        </div>
                                    </div>
                                    <div class="text-sm text-red-600">
                                        @if ($errors->has('betting_rate'))
                                        <li>{{$errors -> first('betting_rate')}}</li>
                                        @endif
                                    </div>
                                </div>
                                <div class="p-2 w-2/3 mx-auto">
                                ...
                                <div class="p-2 w-full flex justify-around mt-4">
                                    <button  type="button" onclick="location.href='{{ route('owner.users.index') }}'" class="text-white bg-gray-400 border-0 py-2 px-8 focus:outline-none hover:bg-gray-300 rounded text-lg">戻る</button>
