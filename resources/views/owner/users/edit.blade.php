                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <section class="text-gray-600 body-font relative">
                       <div class="container px-5 mx-auto">
                            ...
                            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">顧客情報編集</h1>
                            ...
                            <div class="-m-2">
                                ...
                                <div class="p-2 w-full flex justify-around mt-4">
                                    ...
                                    <button type="submit" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-400 rounded text-lg">更新する</button>
                                </div>
                            </div>
                        </form>
                    </div>
